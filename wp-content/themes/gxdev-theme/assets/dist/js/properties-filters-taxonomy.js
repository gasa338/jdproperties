jQuery(document).ready(function($) {
    ...
    const state = {
        ...
        paged:        1,
        perPage:      9,
        term_slug:      propertiesAjax.term_slug,
        taxonomy:      propertiesAjax.taxonomy,
    };
    ...
    function fetchProperties() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action:       'filter_properties_taxonomy',
