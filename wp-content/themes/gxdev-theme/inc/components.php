...
{
?>
    <a class="inline-flex items-center gap-3 bg-accent text-background hover:bg-accent/60 transition-colors duration-500 font-body text-xs tracking-[0.32em] uppercase px-10 py-4" href="<?php echo esc_url($link['url']); ?>" title="<?php echo esc_attr($link['title']); ?>">
...
?>
    <a href="<?php echo esc_url($link['url']); ?>"
        class="group relative inline-flex items-center justify-center px-6 py-2 bg-transparent text-accent tracking-[0.05em] border border-accent no-underline <?php echo esc_attr($class); ?>">
...
function _link_outline($link, $class = '')
{
?>
    <a href="<?php echo esc_url($link['url']); ?>"
        class="group relative inline-flex items-center justify-center px-6 py-2 bg-transparent text-accent tracking-[0.05em] border border-accent no-underline <?php echo esc_attr($class); ?>">
