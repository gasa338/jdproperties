...
<main>
    <section class="section-padding pt-8">
        <div class="container-luxury mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <aside class="hidden lg:block w-72 flex-shrink-0">
                    <div class="sticky top-24 bg-card border border-border rounded-lg p-6 max-h-[calc(100vh-7rem)] overflow-y-auto" id="properties-filters">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="font-heading text-lg font-semibold text-foreground">Filteri</h2>
                            <button id="reset-filters" class="text-xs font-body text-muted-foreground hover:text-accent transition-colors">Resetuj</button>
                        </div>
                        ...
                        <div class="filter-section border-b border-border pb-5 mb-5">
                            <button class="filter-toggle flex items-center justify-between w-full text-left mb-3">
                                <span class="font-heading text-sm font-semibold text-foreground uppercase tracking-wider">Tip oglasa</span>
                                <?php echo $chevron_up; ?>
                            </button>
                        ...
                        <div class="filter-section border-b border-border pb-5 mb-5">
                            <button class="filter-toggle flex items-center justify-between w-full text-left mb-3">
                                <span class="font-heading text-sm font-semibold text-foreground uppercase tracking-wider">Tip nekretnine</span>
                                <?php echo $chevron_up; ?>
                            </button>
                        ...
                        <div class="filter-section border-b border-border pb-5 mb-5">
                            <button class="filter-toggle flex items-center justify-between w-full text-left mb-3">
                                <span class="font-heading text-sm font-semibold text-foreground uppercase tracking-wider">Lokacija</span>
                                <?php echo $chevron_up; ?>
                            </button>
                            <div class="filter-content space-y-2.5">
                        ...
                        <div class="filter-section border-b border-border pb-5 mb-5">
                            <button class="filter-toggle flex items-center justify-between w-full text-left mb-3">
                                <span class="font-heading text-sm font-semibold text-foreground uppercase tracking-wider">Površina (m²)</span>
                                <?php echo $chevron_up; ?>
                            </button>
                        ...
                        <div class="filter-section border-b border-border pb-5 mb-5">
                            <button class="filter-toggle flex items-center justify-between w-full text-left mb-3">
                                <span class="font-heading text-sm font-semibold text-foreground uppercase tracking-wider">Broj soba</span>
                                <?php echo $chevron_up; ?>
                            </button>
                        ...
                        <div class="filter-section border-b border-border pb-5 mb-5">
                            <button class="filter-toggle flex items-center justify-between w-full text-left mb-3">
                                <span class="font-heading text-sm font-semibold text-foreground uppercase tracking-wider">Sprat</span>
                                <?php echo $chevron_up; ?>
                            </button>
                            <div class="filter-content flex flex-wrap gap-2">
                                <?php
                                ...
                                <button
                                    ...
                                    data-value="<?php echo esc_attr($f); ?>"
                        ...
                        <div class="filter-section last:border-0 last:mb-0 last:pb-0 border-b border-border pb-5 mb-5">
                            <button class="filter-toggle flex items-center justify-between w-full text-left mb-3">
                                <span class="font-heading text-sm font-semibold text-foreground uppercase tracking-wider">Spratova u zgradi</span>
                                <?php echo $chevron_up; ?>
                            </button>
                            <div class="filter-content flex flex-wrap gap-2">
                                <?php
                                ...
                                <button
                                    ...
                                    data-value="<?php echo esc_attr($bf); ?>"
                                ><?php echo esc_html($bf); ?></button>
                                <?php endforeach; ?>
                            </div>
                        </div>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        >
                            ...
                            <option value="area_asc">Površina: rastuće</option>
                            <option value="area_desc">Površina: opadajuće</option>
                        </select>
                    </div>
